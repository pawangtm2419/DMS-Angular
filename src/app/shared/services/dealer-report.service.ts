...
export class DealerReportService {
  ...
  getCollectionMtd(data: any): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.post<any[]>(`${environment._url}/dealerCollection/getDealerMTD`, data, httpOptions);
  }
  // Dealer Collection Daywise
  getCollectionDaywise(data: any): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.post<any[]>(`${environment._url}/dealerCollection/getDaywiseCollection`, data, httpOptions);
  }
  // ATS Reports
  ...
  getDelReports(data: any): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.post<any[]>(`${environment._url}/ats/deliveries`, data, httpOptions);
  }
  // Retail Reports
  getretailReports(data: any): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.post<any[]>(`${environment._url}/ats/retails`, data, httpOptions);
  }
  // Advance report
  getAdvReports(data: any): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.post<any[]>(`${environment._url}/ats/atsReport`, data, httpOptions);
  }
  // BG/SD Monitoring
  getBdSdMonitor(): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.get<any[]>(`${environment._url}/bgs/getBGs?path=monitor`,  httpOptions);
  }
  // Old Tractor Reports
  getOldTractReports(data: any): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.post<any[]>(`${environment._url}/vehicle/oldTractorReport`, data, httpOptions);
  }
  // Tehsil Report
  getTehsilReports(data: any): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.post<any[]>(`${environment._url}/vehicle/tehsilReport`, data, httpOptions);
  }
  // Expected Disbursement Report
  getExpDisbReport(data: any): Observable<any[]> {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', token: this._cookie.get('token'), companyCode: environment.companyCode}) };
    return this._http.post<any[]>(`${environment._url}/vehicle/disbursementReport`, data, httpOptions);
  }
